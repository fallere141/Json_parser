...
#ifndef JSON_DECODE_JSON_CONTAINER_H
#define JSON_DECODE_JSON_CONTAINER_H
...
namespace final {
    ...
    struct Getter2<target, Json_container<std::tuple<type_pair<Name, T>, type_pair<Names, Ts>...>>> {
        static auto &get(Json_container<std::tuple<type_pair<Name, T>, type_pair<Names, Ts>...>> &tup) {

            return Getter2<target, Json_container<std::tuple<type_pair<Names, Ts>...>>>::get(
                    static_cast<Json_container<std::tuple<type_pair<Names, Ts>...>> &> (tup));
        }

        static bool hasKey(Json_container<std::tuple<type_pair<Name, T>, type_pair<Names, Ts>...>> &tup) {
            return Getter2<target, Json_container<std::tuple<type_pair<Names, Ts>...>>>::hasKey(
                    static_cast<Json_container<std::tuple<type_pair<Names, Ts>...>> &> (tup));
        }
    };

    template<ctll::fixed_string target, typename ... Ts, ctll::fixed_string ... Names, typename T>
    struct Getter2<target, Json_container<std::tuple<type_pair<target, T>, type_pair<Names, Ts>...>>> {
        static auto &get(Json_container<std::tuple<type_pair<target, T>, type_pair<Names, Ts>...>> &tup) {
            return tup.val;
        }

        static bool hasKey(Json_container<std::tuple<type_pair<target, T>, type_pair<Names, Ts>...>> &tup) {
            return true;
        }
    };

    template<ctll::fixed_string target, typename T>
    struct Getter2<target, Json_container<std::tuple<type_pair<target, T>>>> {
        static bool hasKey(Json_container<std::tuple<type_pair<target, T>>> &tup) {
            return true;
        }

        static auto &get(Json_container<std::tuple<type_pair<target, T>>> &tup) {
            return tup.val;
        }
    };

    template<ctll::fixed_string target, typename T, ctll::fixed_string Name>
    struct Getter2<target, Json_container<std::tuple<type_pair<Name, T>>>> {
        static bool hasKey(Json_container<std::tuple<type_pair<Name, T>>> &tup) {
            return false;
        }
    };
    ...
    auto &
    get_Json(Json_container<std::tuple<type_pair<Names, Ts>...>> &tup) {
        return Getter2<target, Json_container<std::tuple<type_pair<Names, Ts>...>>>::get(tup);
    }


    template<ctll::fixed_string target, typename ... Ts, ctll::fixed_string ... Names>
    bool
    hasKey(Json_container<std::tuple<type_pair<Names, Ts>...>> &tup) {
        return Getter2<target, Json_container<std::tuple<type_pair<Names, Ts>...>>>::hasKey(tup);
    }
    ...
    struct setter<target, target_type, Json_container<std::tuple<type_pair<Name, T>, type_pair<Names, Ts>...>>> {
        static void
        set(Json_container<std::tuple<type_pair<Name, T>, type_pair<Names, Ts>...>> &tup, target_type const &val) {

            return setter<target, target_type, Json_container<std::tuple<type_pair<Names, Ts>...>>>::set(
                    static_cast<Json_container<std::tuple<type_pair<Names, Ts>...>> &> (tup), val);
        }

    };

    template<ctll::fixed_string target, typename target_type, typename ... Ts, ctll::fixed_string ... Names, typename T>
    struct setter<target, target_type, Json_container<std::tuple<type_pair<target, T>, type_pair<Names, Ts>...>>> {
        static void
        set(Json_container<std::tuple<type_pair<target, T>, type_pair<Names, Ts>...>> &tup, target_type const &val) {
            tup.val.val = val;
        }
    ...
    void
    set_Json(Json_container<std::tuple<type_pair<Names, Ts>...>> &tup, target_type const &val) {
        setter<target, target_type, Json_container<std::tuple<type_pair<Names, Ts>...>>>::set(tup, val);
    }
    ...
    struct Json_str_set<target_type, Json_container<std::tuple<type_pair<Name, T>>>> {
...
//////sting
    ...
    template<typename ... Ts, ctll::fixed_string ... Names, typename T, ctll::fixed_string Name>
    struct Json_str_haskey<Json_container<std::tuple<type_pair<Name, T>, type_pair<Names, Ts>...>>> {
        bool set_with_str(Json_container<std::tuple<type_pair<Name, T>, type_pair<Names, Ts>...>> &tup,
                          std::string const &forKey) {
            std::string result(std::basic_string_view<char32_t>(Name).begin(),
                               std::basic_string_view<char32_t>(Name).end());
            if (result == forKey) {
    ...
    template<typename T, ctll::fixed_string Name>
    struct Json_str_haskey<Json_container<std::tuple<type_pair<Name, T>>>> {
        bool set_with_str(Json_container<std::tuple<type_pair<Name, T>>> &tup, std::string const &forKey) {
    ...
    template<typename ... Ts, ctll::fixed_string ... Names>
    bool
    value_haskey(Json_container<std::tuple<type_pair<Names, Ts>...>> &tup, std::string const &forKey) {
        Json_str_haskey<Json_container<std::tuple<type_pair<Names, Ts>...>>> util;
    ...
    template<typename ... Ts, ctll::fixed_string ... Names, typename T, ctll::fixed_string Name>
    struct Json_turn_str<Json_container<std::tuple<type_pair<Name, T>, type_pair<Names, Ts>...>>> {
        std::string get_Json_str(Json_container<std::tuple<type_pair<Name, T>, type_pair<Names, Ts>...>> &tup) {
    ...
    template<typename T, ctll::fixed_string Name>
    struct Json_turn_str<Json_container<std::tuple<type_pair<Name, T>>>> {

        std::string get_Json_str(Json_container<std::tuple<type_pair<Name, T>>> &tup) {
            std::string key(std::basic_string_view<char32_t>(Name).begin(),
                            std::basic_string_view<char32_t>(Name).end());
            return std::format("\"{}\":{},", key, tup.val.val);
        };
    ...
    template<ctll::fixed_string Name>
    struct Json_turn_str<Json_container<std::tuple<type_pair<Name, std::string>>>> {
    ...
    template<typename ... Ts, ctll::fixed_string ... Names>
    std::string get_Json_str(Json_container<std::tuple<type_pair<Names, Ts>...>> &tup) {
        Json_turn_str<Json_container<std::tuple<type_pair<Names, Ts>...>>> util;
        return "{" + util.get_Json_str(tup) + "}";
    };

}
#endif //JSON_DECODE_JSON_CONTAINER_H
